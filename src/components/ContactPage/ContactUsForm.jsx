...
const ContactUsForm = () => {
  ...
  const {                                                                                          //  useForm() hook se ye sare data nikal lo
    register,                                                                                      //  Iska use hota hai input fields ko form ke saath connect karne ke liye. Jab bhi koi <input /> field banate ho, toh register("fieldName") use karte ho usse form ke data ke saath jodne ke liye.
    handleSubmit,                                                                                  //  Ye ek function hai jo form submit hone par call hota hai. Jab user submit karega, toh ye function validate karega sab input fields ko aur phir ek callback ko call karega agar sab sahi hua.
    reset,                                                                                         //  Ye function form ko reset (saaf) karne ke kaam aata hai. Jaise form fill karne ke baad sab input fields ko empty karna ho.
  ...
  const submitContactForm = async (data) => {
    ...
    try {
      ...
      const res = await apiConnector(                                                              //  API call 'apiConnector' function se ho rahi hai, jisme method "POST" hai
        "POST",
        contactusEndpoint.CONTACT_US_API,                                                          //  'CONTACT_US_API' call kar rahe hain
        data                                                                                       //  Ye wo actual data hai jo tu user se form mein bharwa ke bhej raha hai.
      )
  ...
  return (
    ...
    <form
      ...
      onSubmit={handleSubmit(submitContactForm)}                                                   //   jab bhi form submit hoga to --> submitContactForm <-- iss function ko call kar dena.  handleSubmit() ka kaam hai form ko validate karna pehle, uske baad hi submitContactForm() function ko call karna.
    >
